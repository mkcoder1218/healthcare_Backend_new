...
const generatePaths = () => {
  ...
  paths["/payment/create-order"] = {
    post: {
      summary: "Create an order with AddisPay",
      tags: ["Payment"],
      requestBody: {
        required: true,
        content: {
  ...
  paths["/payment/payout"] = {
    post: {
      summary: "Initiate a payout (B2C)",
      tags: ["Payment"],
      requestBody: {
        required: true,
...
const options: Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "All endpoints require JWT bearer",
    },
    servers: [{ url: "/api" }],
    components: {
