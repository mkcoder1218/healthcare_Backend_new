...
export const validationSchemas: Record<string, Joi.ObjectSchema> = {
  ...
  Booking: Joi.object({
    ...
    payment_status: Joi.string()
      .valid("Paid", "Unpaid", "Pending", "Failed")
      .required(),
  }),
  ...
  PaymentMethod: Joi.object({
    ...
    description: Joi.string().optional().allow(null),
    icon_url: Joi.string().optional().allow(null),
...
export const validationUpdateSchemas: Record<string, Joi.ObjectSchema> = {
  ...
  PaymentMethod: validationSchemas.PaymentMethod.fork(
    Object.keys(validationSchemas.PaymentMethod.describe().keys),
    (schema) => schema.optional(),
  ),
};
